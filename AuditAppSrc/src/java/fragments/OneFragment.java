        ...
        try {
            ...
            if (isInternetPresent) {
                ...
                if (jsonResult == null) {
                    ...
                    jsonMainNode = jsonResponse.optJSONArray("assign");// assign is our json object name in mysql database
                    if(jsonMainNode== null)
                    {
                        ...
                        for (int i = 0; i < jsonMainNode.length(); i++) {
                            ...
                            String adID = jsonChildNode.optString("ad_inventory_id");
                            String location = jsonChildNode.optString("location");
                            String societyAddress = jsonChildNode.optString("address");
                            String submitStatus = jsonChildNode.optString("submit_status");
                            String date = jsonChildNode.optString("assigned_date");
                            String inventoryType = jsonChildNode.optString("adinventory_type");
                            String business_name = jsonChildNode.optString("business_name");
                            String audit_type = jsonChildNode.optString("audit_type");
//                            prepareDataData(adID, societyAddress,inventoryType ,location,picture,submitStatus,date,inventoryType,business_name,audit_type);
