...
public class sellerDashboard extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("myDashboard(seller)");
        ...
        menu = getResources().getStringArray(R.array.menu_seller);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(menu[position].equals("logout")){
            ...
            manageScreens.saveToPrefrence(sellerDashboard.this,prefname,prefvalue);
